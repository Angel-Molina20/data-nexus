...
def test_pagination_is_applied_to_ast_without_mutating_original() -> None:
    ...
    paged = paginate_query(original, page=2, page_size=50, max_rows=5000)
    ...
    last = paginate_query(original, page=3, page_size=50, max_rows=5000)
...
def test_parameter_defaults_are_copied_without_exposing_sensitive_defaults() -> None:
    ...
    assert resolve_parameters(definitions, {}) == {"search": "active"}
