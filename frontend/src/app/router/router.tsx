...
export const router = createBrowserRouter([
  { path: "/login", Component: LoginPage },
  {
    ...
    children: [
      ...
      {
        path: "connections/:id/relationships/polymorphic/new",
        Component: PolymorphicRelationshipPage,
      },
      { path: "connections/:id/semantic-catalog", Component: SemanticCatalogPage },
      {
        path: "queries",
        element: (
          <PermissionGuard permission="queries.read">
            <QueriesPage />
          </PermissionGuard>
        ),
      },
      {
        path: "queries/new",
        element: (
          <PermissionGuard permission="queries.create">
            <NewQueryPage />
          </PermissionGuard>
        ),
      },
      ...
      {
        path: "queries/:id/edit-json",
        element: (
          <PermissionGuard permission="queries.update">
            <QueryJsonEditorPage />
          </PermissionGuard>
        ),
      },
      {
        path: "queries/:id/compile",
        element: (
          <PermissionGuard permission="queries.compile">
            <QueryCompilePage />
          </PermissionGuard>
        ),
      },
